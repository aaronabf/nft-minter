"""
Ported from https://github.com/metaplex-foundation/python-api.
"""
import base58
...
from .transactions import deploy, topup, mint, send, burn, update_token_metadata

class MetaplexAPI():

    def __init__(self, public_key, private_key, decryption_key):
        self.private_key = list(base58.b58decode(private_key))[:32]
